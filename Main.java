...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			String[] dayOfaWeekStr = {"", "Niedziela","Poniedzia³ek","Wtorek","Œroda","Czwartek","Pi¹tek","Sobota"};
			Scanner scanner = new Scanner(System.in);
	        System.out.println("Wpisz datê w formacie dd/mm/yyyy");
	        ...
	        System.out.println("Za rok tego dnia bêdziemy mieli: " + dayOfaWeekStr[dayOfaWeekInt]); 
		}
	}
